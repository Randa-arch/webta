...
@section('title', 'Profil | Website Sistem Pemantauan Kondisi Toilet')
          ...
          <div class="col-xl-4">
            ...
            <div class="card">
              <div class="card-body profile-card pt-4 d-flex flex-column align-items-center">
                ...
                <h3>Petugas Kebersihan Gedung H</h3>
              </div>
            </div>
                ...
                <div class="tab-content pt-2">
                  ...
                  <div class="tab-pane fade show active profile-overview" id="profile-overview">
                    ...
                    <div class="row">
                      ...
                      <div class="col-lg-9 col-md-8">Petugas Kebersihan</div>
                    </div>
  
                    <div class="row">
                      <div class="col-lg-3 col-md-4 label">Gedung</div>
                      <div class="col-lg-9 col-md-8">Gedung H</div>
                    </div>
  
                    <div class="row">
                      <div class="col-lg-3 col-md-4 label">Nomor HP</div>
                      <div class="col-lg-9 col-md-8">081374xxxxxx</div>
                    </div>
                  ...
                  <div class="tab-pane fade profile-edit pt-3" id="profile-edit">
                    ...
                    <form>
                      ...
                      <div class="row mb-3">
                        <label for="company" class="col-md-4 col-lg-3 col-form-label">Posisi</label>
                        <div class="col-md-8 col-lg-9">
                      ...
                      <div class="row mb-3">
                        <label for="Job" class="col-md-4 col-lg-3 col-form-label">Gedung</label>
                        <div class="col-md-8 col-lg-9">
